...
| `@bot <图片>` | 发送图片让 AI 分析描述 |
| `@bot <文字+图片>` | 图文结合，AI 基于图片回答 |
...
User: @bot [图片]
Bot:  这张图片展示了一只橙色的猫坐在窗台上，
      背景是阳光明媚的花园。猫咪看起来非常放松...

User: @bot 这张图片里有什么文字？ [图片]
Bot:  图片中的文字内容是"欢迎来到 Milky Chat"，
      字体是黑色的，位于图片正中央。
```
